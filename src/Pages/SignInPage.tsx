  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10">
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <p className="mt-1 text-sm text-slate-300">Login to add, edit, or delete watchlist items.</p>
        ...
        <p className="mt-4 text-sm text-slate-300">
          No account yet?{' '}
          <Link className="font-semibold text-white underline underline-offset-4" to="/signup">
            Create one
          </Link>
        </p>
      </div>
